...
namespace Tests
{
    public class FSMWithClassesShould
    {
        [Test]
        ...
        {
            FSM<string, string> fsm = null;

            IEqualityComparer<string> comparer = null;

            Assert.Throws<ArgumentNullException>(() => new FSM<string, string>(comparer, comparer));

            fsm = new FSM<string, string>();
        ...
        public void Use_Custom_Equality_Comparer()
        {
            ...
            var fsm = new FSM<string, string>(comparer, comparer);
